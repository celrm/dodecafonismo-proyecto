...
\end{changemargin}
	...
	\end{wrapfigure} 
		...
		En el código QR está el enlace de la aplicación web. Sus instrucciones de uso se encuentran al final de la página. El enlace es \linebreak\textit{https://diagramas.netlify.com/}.
		
		Además, he creado un comando en \LaTeX{} que dibuja estos diagramas dada su serie y su nombre, así como el número que está arriba:\linebreak \verb|\ddiagram[4]{4,5,7,1,6,3,8,2,11,0,9,10}{T$^0$}| -- en este caso \verb|[4]| no es necesario, ya que por defecto se coloca arriba la primera nota de la serie.
