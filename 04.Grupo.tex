\chapter{EL GRUPO DE LAS TRANSFORMACIONES}\label{ch:grupo}
...
\end{changemargin}
		...
		\vspace*{-\smallskipamount}\begin{center}
			\begin{multicols}{2}
				\ddiagram[4]{10,9,0,11,2,8,3,6,1,7,5,4}{R}
	...
	\end{wrapfigure} 
		...
		En el código QR está el enlace de la aplicación web. Sus instrucciones de uso se encuentran al final de la página. El enlace es \url{https://diagramas.netlify.com}.
		
		Además, he creado un comando en \LaTeX{} que dibuja estos diagramas dada su serie y su nombre, así como el número que está arriba:\linebreak \verb|\ddiagram[4]{4,5,7,1,6,3,8,2,11,0,9,10}{T$^0$}| -- en este caso \verb|[4]| no es necesario, ya que por defecto se coloca arriba la primera nota de la serie. El código se encuentra en el Anexo \ref{app:latex}, página \pageref{app:latex2}.
	...
	\begin{changemargin}{-0.5cm}{-0.5cm}
		\begin{multicols}{2}
			...
			\draw [very thick,dash pattern={on 1pt off 4pt on 10pt off 3pt}] (0,-3.5) -- (0,3.5);
		...
		\begin{multicols}{2}
			...
			\draw [very thick,dash pattern={on 1pt off 3pt on 7pt off 2pt}] (0,-2) -- (0,2);
