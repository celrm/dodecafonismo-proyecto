\section{Análisis de una obra dodecafónica: el opus 25}\label{ch:suite}
	...
	\label{musette}
		...
		A continuación se encuentra el análisis serial completo de la Musette:\xxx{Probablemente, es mucho trabajo, pero diría de cambiar los colores. No se ven bien en la pantalla, en especial el amarillo. Al menos, cambiaría las letras del encabezado a letras con la silueta negra. Otra opción es poner en el encabezado un fondo oscuro y que así se vean mejor. En realidad, en la partitura se ven bien los colores.}
