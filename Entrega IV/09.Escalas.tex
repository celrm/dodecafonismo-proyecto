...
\begin{center}
\includegraphics[width=14cm]{Fotos/Re-escalando-musica-fig-1.png}
\end{center}
...
\begin{center}
\includegraphics[width=12cm]{Fotos/Re-escalando-musica-fig-2.png}
\end{center}
...
$$cq + (c+1)r = cq + cr + r =c(q+r) + r =	c|E| + r = 12$$
 lo cual se cumple por el algoritmo de la división, que asegura que al dividir 12 entre $|E|$ existen su cociente $c$ y su resto $r\geq0$, como queríamos probar.
