	...
	\section[ESPECTROS DEL GRUPO D$_{n}$ x D$_{n}$]{ESPECTROS DEL GRUPO D$_{\textbf{\textit{n}}}$ x D$_{\textbf{\textit{n}}}$}
		...
		Los elementos estables mediante I son aquellos que quedan invariantes mediante reflexiones. En este punto se ha de separar por paridad de $n$. Para $n$ impar, existen reflexiones para cada uno de los ejes de simetría que pasan por cada vértice. Se puede escoger dicho eje de $n$ formas. Después, hay $n$ formas de escoger el primer vértice de la secuencia. Ahora hay $\frac{n-1}{2}$ parejas de vértices; se escoge los primeros miembros entre ellos de $2^{\frac{n-1}{2}}$ formas, tras lo cual éstos se ordenan de $\frac{n-1}{2}!$ formas. Esto da un resultado de  $n^2\cdot2^{\frac{n-1}{2}}\cdot\frac{n-1}{2}!$ polígonos invariantes.
		
		Para $n$ par se tienen las simetrías con ejes que pasan por vértices y ejes que pasan por lados. Para las simetrías con ejes que pasan por vértices, se puede escoger dicho eje de $\frac{n}{2}$ formas. Después, hay $n$ formas de escoger el primer vértice de la secuencia. Ahora hay $\frac{n}{2}$ parejas de vértices; se escoge los primeros miembros entre ellos de $2^{\frac{n}{2}}$ formas, tras lo cual éstos se ordenan de $\left(\frac{n}{2}-1\right)!$ formas. No son $\frac{n-1}{2}!$ porque el primero ya está escogido: debe ser el del eje. Esto da un resultado de  $\frac{n^2}{2}\cdot2^{\frac{n}{2}}\cdot\left(\frac{n}{2}-1\right)!$ polígonos invariantes.
		
		Para las simetrías con ejes que pasan por lados, se puede escoger dicho eje de $\frac{n}{2}$ formas. Después, hay $n$ formas de escoger el primer vértice de la secuencia. Ahora hay $\frac{n}{2}-1$ parejas de vértices -- no hay $\frac{n}{2}$ porque la primera pareja ya se ha escogido --; se escoge los primeros miembros entre ellos de $2^{\frac{n}{2}-1}$ formas, tras lo cual éstos se ordenan de $\frac{n}{2}!$ formas. Esto da un resultado de $\frac{n^2}{2}\cdot2^{\frac{n}{2}-1}\cdot\frac{n}{2}!$ polígonos invariantes.
		
		En resumen, estos son los numeradores $\sum_{\Psi\in\text{D}_{n}\times\text{D}_{n}}\text{Fij}(\Psi)$. El resultado final del número de diagramas posibles, o espectros seriales distintos, es dicho numerador entre $4n^2$, el tamaño del grupo. \footnote{Este apartado es una explicación detallada del artículo \cite{polygons}. La secuencia de números dada por las fórmulas demostradas se encuentra en la OEIS (On-Line Encyclopedia of Integer Sequences): \textit{https://oeis.org/A000940}}		
